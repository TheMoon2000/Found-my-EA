...
class ParticipantView: NSTableCellView, NSPopoverDelegate, NSTextFieldDelegate {
    ...
    func updateEA(_ EA: String, id: String, key: String, value: String) {
        ...
        let postString = "EA=\(EA)&ID=\(id)&key=\(key)&value=\(value)"
        Swift.print(postString)
            ...
            do {
                ...
                DispatchQueue.main.async {
                    ...
                    if value == "Approved" {
                        ...
                        mainViewController?.participantsUpdate(self.EA_Name, pID: self.toolTip!.components(separatedBy: "\r")[0].components(separatedBy: ": ")[1])
                    }
        ...
        let task = URLSession.shared.dataTask(with: request) {
            ...
            do {
                ...
                DispatchQueue.main.async {
                    ...
                    alert.beginSheetModal(for: mainViewController!.view.window!, completionHandler: nil)
                }
            }
            hasRun = true
            return
